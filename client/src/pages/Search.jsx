...
export default function Search() {
    ...
    const handleChange = (e) => {
       ...
       //based on sidebardata we have to change the url
  ...
  return (
    <div className='flex flex-col md:flex-row'>
        ...
        <form className='flex flex-col gap-8' onSubmit={handleSubmit}>
            ...
            <input type = 'text' placeholder='Search...'id='searchTerm' className='border rounded-lg w-full p-3'value={sidebardata.searchTerm} onChange={handleChange}/>
            </div>
